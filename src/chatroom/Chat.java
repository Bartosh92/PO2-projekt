...
public class Chat {
    ...
    private JTextArea MessageArea = new JTextArea();
     // Panel do wyświetlania wiadomości
    ...
    public void createChatArea() {
        ...
        this.chatArea.setBackground(new Color(166, 166, 170));
    ...
    public void createChatPanel() {
        this.chat_panel.setLayout(new BorderLayout());  // Ustawiamy layout na BorderLayout
    ...
    public String getMessage() {
        return this.chatArea.getText().trim();
    }

    // Metoda renderująca panel
